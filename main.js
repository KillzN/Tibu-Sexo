...
import Pino from 'pino'
import { TibuJadiBot } from './plugins/jadibot-serbot.js'
...
TibuJadiBot({pathTibuJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}
}
}
}
